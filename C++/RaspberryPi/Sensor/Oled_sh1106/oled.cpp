...
std::cout<<"begin clear in Init Func" << std::endl;
this->clear();
std::cout<<"end  clear in  Init Func" << std::endl;


std::cout<<"begin Display in Init Func" <<std::endl;
this->display(); 
std::cout<<"end Display in Init Func" <<std::endl;
