...
#include <memory>
#include "../C--QT-Sql-AnimalShop/searchtable.h"
...
QT_MOC_LITERAL(1, 12, 13), // "buy_selection"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "searchtable\0buy_selection\0"
};
...
void searchtable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<searchtable *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->buy_selection(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject searchtable::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_searchtable.data,
    qt_meta_data_searchtable,
    qt_static_metacall,
    nullptr,
    nullptr
} };
